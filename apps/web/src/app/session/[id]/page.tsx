  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      <div
        ...
        style={{ height: 40, background: "var(--panel)" }}
      >
        {/* Language picker */}
        <div className="relative">
          ...
          >
            <span
              ...
              style={{ background: LANG_COLORS[language] ?? "#8B949E" }}
            />
            {language}
          ...
          {langOpen && (
            <>
              ...
              <div
                className="absolute left-0 top-full mt-1 z-20 min-w-[130px] rounded-[6px] overflow-hidden py-0.5"
                style={{
                  background: "var(--elevated)",
                  border: "1px solid var(--border-strong)",
                ...
                {LANGUAGES.map((lang) => (
                  <button
                    ...
                    style={{
                      ...
                      background: language === lang ? "rgba(0,217,192,0.08)" : "transparent",
                    }}
                    onMouseEnter={e => {
                      if (language !== lang) e.currentTarget.style.background = "var(--hover)"
                    }}
                    onMouseLeave={e => {
                      e.currentTarget.style.background = language === lang
                        ? "rgba(0,217,192,0.08)"
                        : "transparent"
                    }}
                  >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-all"
          style={{
            background: terminalOpen ? "rgba(0,217,192,0.08)" : "var(--elevated)",
            border: terminalOpen ? "1px solid rgba(0,217,192,0.3)" : "1px solid var(--border-strong)",
        ...
        <button
          onClick={handleRun}
          className="flex items-center gap-1.5 px-3 py-1 rounded text-xs font-semibold font-ui transition-all"
          style={{
        ...
        {terminalOpen && (
          ...
          >
            <div
              ...
              style={{ height: 32, borderColor: "rgba(255,255,255,0.06)" }}
            >
            ...
            <div className="flex-1 flex items-center justify-center">
              <span className="text-[11px] font-mono text-text-dim">
                Press <span style={{ color: "var(--accent)" }}>Run</span> to execute your code
              </span>
            </div>
          </div>
        )}
